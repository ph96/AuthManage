...
//****************************更新用户权限*******************************************************************************		
    	...
    	function updateAuth(){
            ...
            var userId=$("#userId").val();
      		...
      		if(!!authIds){
      			$("#authIds").val(authIds);
      			$("#authForm").attr("action","${pageContext.request.contextPath}/indexUserManage/updateAuthUser.action");
      			$("#authForm").submit();
		    }else{
		    	alert("请选择要修改的权限");
		    } 
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row placeholders">
					...
					<div>
						...
						<a href="${pageContext.request.contextPath}/indexUserManage/fullUser.action">
